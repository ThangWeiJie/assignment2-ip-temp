...
<body>
  ...
  <tr>
    <div class="form-control">
      <td>Quantity: <input type="number" name="set1Quantity" value="0" size="5" min="0" max="20"/></td>
      <td>Quantity: <input type="number" name="set2Quantity" value="0" size="5" min="0" max="20" /></td>
    </div>
  </tr>
